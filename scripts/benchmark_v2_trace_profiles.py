...
from benchmark_v2_churn import BenchmarkConfig
from benchmark_v2_churn import ModeConfig
from benchmark_v2_churn import maintenance_policy
from benchmark_v2_churn import maintenance_state
from benchmark_v2_churn import make_docs
from benchmark_v2_churn import make_queries
from benchmark_v2_churn import measure_query
from benchmark_v2_churn import parse_rebuild_count
from benchmark_v2_churn import random_doc
from benchmark_v2_churn import setup_table
from benchmark_v2_churn import summarize_mode
from benchmark_v2_churn import vacuum_table
...
TRACE_PROFILES = [
    TraceProfile(
        ...
        db_name='psql_bm25s_v2_trace_read_heavy',
        doc_count=12000,
        query_count=180,
        steps=(
            TraceStep(
    ...
    TraceProfile(
        name='bursty_ingest',
        db_name='psql_bm25s_v2_trace_bursty_ingest',
        doc_count=15000,
        query_count=160,
        steps=(
            TraceStep(
    ...
    TraceProfile(
        ...
        db_name='psql_bm25s_v2_trace_hotset',
        doc_count=10000,
        query_count=140,
        steps=(
            TraceStep(
    ...
    TraceProfile(
        ...
        db_name='psql_bm25s_v2_trace_retention',
        doc_count=14000,
        query_count=150,
        steps=(
            TraceStep(
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description='Run v2 production-shaped churn trace profiles.'
    )
    parser.add_argument(
        '--profile',
        action='append',
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(
        prefix='psql_bm25s_v2_trace_profiles_'
    ):
