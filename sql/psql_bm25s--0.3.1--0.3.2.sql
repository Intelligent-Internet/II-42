-- 0.3.2 adds the field-aware multicolumn retrieval surface
-- and makes user-facing search APIs consistently return hit rowsets.

ALTER TYPE psql_bm25s_hit
    RENAME TO psql_bm25s_result_hit;
ALTER TYPE psql_bm25s_prepared_query
    RENAME TO psql_bm25s_result_prepared_query;
ALTER TYPE psql_bm25s_ranked_query
    RENAME TO psql_bm25s_result_ranked_query;
ALTER TYPE psql_bm25s_weighted_query
    RENAME TO psql_bm25s_result_fusion_weighted_query;
ALTER TYPE psql_bm25s_field_query
    RENAME TO psql_bm25s_result_fusion_field_query;
ALTER TYPE psql_bm25s_hybrid_candidate
    RENAME TO psql_bm25s_result_hybrid_candidate;
ALTER TYPE psql_bm25s_hybrid_hit
    RENAME TO psql_bm25s_result_hybrid_hit;
...
ALTER FUNCTION psql_bm25s_search_ids(regclass, int4[], int4, real[])
    RENAME TO psql_bm25s_query_ids;

ALTER FUNCTION psql_bm25s_search_tokens(regclass, text[], int4, real[])
    RENAME TO psql_bm25s_query_tokens;

ALTER FUNCTION psql_bm25s_query(
    regclass,
    text,
    boolean,
    text[],
    boolean,
    boolean
) RENAME TO psql_bm25s_prepared_query;

ALTER FUNCTION psql_bm25s_search_prepared_query(
    psql_bm25s_result_prepared_query,
    int4,
    real[]
) RENAME TO psql_bm25s_query_prepared;
...
ALTER FUNCTION psql_bm25s_score_ids_op(int4[], int4[])
    RENAME TO psql_bm25s_op_score_ids;

ALTER FUNCTION psql_bm25s_score_tokens_op(text[], text[])
    RENAME TO psql_bm25s_op_score_tokens;
ALTER FUNCTION psql_bm25s_score_tokens_op(text[], varchar[])
    RENAME TO psql_bm25s_op_score_tokens;
ALTER FUNCTION psql_bm25s_score_tokens_op(varchar[], text[])
    RENAME TO psql_bm25s_op_score_tokens;
ALTER FUNCTION psql_bm25s_score_tokens_op(varchar[], varchar[])
    RENAME TO psql_bm25s_op_score_tokens;

ALTER FUNCTION psql_bm25s_match_query_tokens_op(text[], text)
    RENAME TO psql_bm25s_op_match_query_tokens;
ALTER FUNCTION psql_bm25s_match_query_tokens_op(varchar[], text)
    RENAME TO psql_bm25s_op_match_query_tokens;

ALTER FUNCTION psql_bm25s_score_scalar_text_op(text, text[])
    RENAME TO psql_bm25s_op_score_scalar_text;
ALTER FUNCTION psql_bm25s_score_scalar_text_op(text, varchar[])
    RENAME TO psql_bm25s_op_score_scalar_text;
ALTER FUNCTION psql_bm25s_score_scalar_text_op(varchar, text[])
    RENAME TO psql_bm25s_op_score_scalar_text;
ALTER FUNCTION psql_bm25s_score_scalar_text_op(varchar, varchar[])
    RENAME TO psql_bm25s_op_score_scalar_text;

ALTER FUNCTION psql_bm25s_match_query_scalar_op(text, text)
    RENAME TO psql_bm25s_op_match_query_scalar;
ALTER FUNCTION psql_bm25s_match_query_scalar_op(varchar, text)
    RENAME TO psql_bm25s_op_match_query_scalar;

ALTER FUNCTION psql_bm25s_match_prepared_query_op(
    text[],
    psql_bm25s_result_prepared_query
) RENAME TO psql_bm25s_op_match_prepared_query;
ALTER FUNCTION psql_bm25s_match_prepared_query_op(
    varchar[],
    psql_bm25s_result_prepared_query
) RENAME TO psql_bm25s_op_match_prepared_query;

ALTER FUNCTION psql_bm25s_match_prepared_query_scalar_op(
    text,
    psql_bm25s_result_prepared_query
) RENAME TO psql_bm25s_op_match_prepared_query_scalar;
ALTER FUNCTION psql_bm25s_match_prepared_query_scalar_op(
    varchar,
    psql_bm25s_result_prepared_query
) RENAME TO psql_bm25s_op_match_prepared_query_scalar;
